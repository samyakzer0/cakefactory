...
export const CakeShopModel = () => {
    const shopRadius = 3.5;
    ...
    return (
        <group>
            ...
            <mesh position={[0, 0.05, 0]} receiveShadow material={materials.pavement}>
                <cylinderGeometry args={[6, 6, 0.1, 32]} />
            </mesh>

            {/* Building Walls */}
            <mesh position={[0, shopHeight / 2 + 0.1, 0]} castShadow receiveShadow material={materials.wall}>
                <cylinderGeometry args={[shopRadius, shopRadius, shopHeight, 32]} />
            </mesh>

            {/* Main Roof (Chocolate Layer) */}
            <group position={[0, shopHeight + 0.3, 0]}>
            ...
            <group position={[-1.8, 1.2, 2.8]} rotation={[0, 0.2, 0]}>
